...
Block3 foo( coord0, coord1, Nx, Ny, Nz); // Generates rect. 3D mesh</code></pre>			
		...
		<section style="font-size:0.9em">
			<h2>Sample</h2>
			{% highlight cpp linenos hljs %}while (time < endTime) {
...
<section>
		...
		<h2 style="margin-bottom:0px; padding-left:140px; text-align:left; text-transform:lowercase; font-family:monospace;">girdap</h2>
		</div>
        <div class="fragment"> Download and/or use for your purpose without obligations (Open source)</div>
	</section>
