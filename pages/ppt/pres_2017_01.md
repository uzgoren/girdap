...
<!--blockquote data-fragment-index=4 style="color:rgba(210, 150, 40,1); margin:10px 5px; font-family:'open sans'; font-weight:normal;  color:#f93;background:url({{ site.baseurl }}/images/pres/icon-quotation.png) no-repeat; padding-left:40px; background-size:32px 32px;text-align:left;font-size:0.7em;"--><span style="color:rgba(240, 120, 40,1);margin-top:10px;">when to communicate, adapt, iterate etc.</span><!--/blockquote--></li>
...
<li class="fragment"> Seek EU funding for larger collaborations
</ul>
</li> 
</ul>
</section>
